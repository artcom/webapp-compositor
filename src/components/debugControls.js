...
const DebugControls = () => {
  ...
  useControls({
    ...
    closeButton: folder({
      ...
      closeButtonLeft: { value: DEFAULT_STYLE.LEFT, type: LevaInputs.STRING, label: "left" },
      closeButtonTop: { value: DEFAULT_STYLE.TOP, type: LevaInputs.STRING, label: "top" },
      closeButtonWidth: { value: DEFAULT_STYLE.WIDTH, type: LevaInputs.STRING, label: "width" },
      closeButtonHeight: { value: DEFAULT_STYLE.HEIGHT, type: LevaInputs.STRING, label: "height" },
        ...
        startWebApp(
          {
            ...
            ...(get("closeButton.isActive") && {
              closeButton: {
                ...
                left: get("closeButton.closeButtonLeft"),
                top: get("closeButton.closeButtonTop"),
                width: get("closeButton.closeButtonWidth"),
                height: get("closeButton.closeButtonHeight"),
